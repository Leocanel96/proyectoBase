...
class platillosController extends Controller
{
    ...
    function guardarPlatillo(Request $request)
    {
        ...
        if ($request->hasFile('imagen')) {
            ...
            $rutaDestino = '/storage/img/platillos/';
            $ruta = '/storage/img/platillos/' . $nombreImagen;
            $imagen->move(public_path('storage/img/platillos'), $nombreImagen);

        }
        $nombrePlatillo = $request->nombrePlatillo;
        $descripcionPlatillo = $request->descripcionPlatillo;
        $idTipoPlatillo = $request->idTipoPlatillo;
        $nombretipoPlatillo = $request->nombreTipoPlatillo;
        $precioPlatillo = $request->precioPlatillo;
        $idPromocion = $request->idPromocionPlatillo;
        $tipoPromocion = $request->tipoPromocionPlatillo;
        $montoPromocion = $request->montoPromocionPlatillo;
        ...
        $agregarPlatillo->nombre_imagen = $nombreImagen;
        $agregarPlatillo->ruta_imagen = $ruta;
